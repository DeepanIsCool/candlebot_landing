...
} from "@/lib/calculators/fixed-deposit";
import {
  calculateCapitalGainsTax,
  compareTaxRegimes,
} from "@/lib/calculators/income-tax-calculator";
import {
  calculateReturnsWithExpenses,
  compareFunds,
} from "@/lib/calculators/mutual-fund-calculator";
import {
  calculateRequiredSIP,
  calculateSIPFutureValue,
  calculateStepUpSIP,
} from "@/lib/calculators/sip-calculator";
import {
  calculatePerpetualWithdrawal,
  calculateSWP,
  calculateSustainableWithdrawal,
} from "@/lib/calculators/swp-calculator";
import {
  Banknote,
  BarChart3,
  Calculator,
